<div class="flex justify-center" x-data="scan">
    <template x-if="mode == 'scan'">
        <div class="mt-14">
            ...
            <div x-data="imageViewer()" class="w-[400px] h-[300px]">
                <label for="ktp" class="flex flex-col items-center justify-center w-full h-full border-2 border-gray-300 border-solid rounded-lg cursor-pointer bg-white dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-200 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
