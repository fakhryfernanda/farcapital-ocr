<div class="flex flex-col justify-center bg-gray-50 gap-1 rounded-md mb-10 py-5 mt-10 shadow shadow-gray-400">
    ...
    <div class="mx-auto w-[500px] my-3 p-4 bg-white shadow-md shadow-gray-400 rounded-sm border-gray-300">
        ...
        <hr class="my-2">
        <p>Dengan ini saya (pemilik data) menyatakan bahwa semua data dan file (KTP) yang diinput benar dan dapat dipertanggungjawabkan secara hukum.</p>
        <div class="flex justify-between">
            <div class="my-1">
                <input type="checkbox" name="" id="eula">
                <label for="eula" class="font-bold">Setuju</label>
            </div>
            <p>aaaaaaaaaa</p>
        </div>
        <hr class="my-2">
        <p>Pastikan untuk mengecek ulang semua data diatas untuk menghindari kesalahan data</p>
    </div>
