<section class="min-h-1/2 flex text-white " x-data="userLogin" >
    ...
    <div x-show="!isloading" class="w-[500px] bg-white  rounded-xl shadow-lg shadow-gray-600/50 flex items-center justify-center text-center md:px-16 px-0 z-0">
            ...
            <div class="py-1 space-x-2 flex justify-center">
                ...
                <div class="px-2 pb-2 pt-4">
                    ...
                    <div class="flex justify-center px-4 pb-2">
                        <input type="submit" @click="submit()" class="btn-primary w-1/2" value="Submit">
                    </div>
