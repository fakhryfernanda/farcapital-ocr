        ...
        <div class="w-full py-6 z-20">
            ...
            <div class="py-1 space-x-2 flex justify-center">
                ...
                <div class="pb-2 pt-4 text-white flex">
                    ...
                    <input type="email" x-model="email" placeholder="Email"  class="block w-full p-2 text-lg rounded text-black font-Lato font-bold border-2 " x-bind:class="errarea == 'email'?'border border-red-600  bg-red-100' : 'border-gray-500 bg-white'">
                </div>
                ...
                <div class="pb-2 pt-4 flex text-white">
                    ...
                    <input class="block w-full p-2 text-lg rounded bg-white text-black font-Lato font-bold border-2 " x-bind:class="errarea == 'password'?'border border-red-600 bg-red-100' : 'border-gray-500'" type="password" x-model="password" placeholder="Password">
                </div>
